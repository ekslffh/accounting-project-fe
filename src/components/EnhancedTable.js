    ...
    <TableHead>
      <TableRow>
        ...
        {headCells.map((headCell) => (
          ...
          >
            <TableSortLabel
              active={orderBy === headCell.useDate}
              direction={orderBy === headCell.useDate ? order : 'asc'}
...
export default function EnhancedTable(props) {
  ...
  const [orderBy, setOrderBy] = React.useState('useDate');
  ...
  return (
    <Box sx={{ width: '100%' }}>
      <Paper sx={{ width: '100%', mb: 2 }}>
        <EnhancedTableToolbar numSelected={selected.length} getSelected={getSelected} />
        <TableContainer>
          <Table
            sx={{ minWidth: 750 }}
